...
def answer(state: AgentState):
    ...
    1. Lease-related → use lease context and cite section/page. for lease realted questions clear sentences just give answer along with session and page do not include anything like lease-related in answer.
